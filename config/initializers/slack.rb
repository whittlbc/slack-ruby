...
def new_poll
  ...
  answer1 = "\n1. <https://dry-retreat-2699.herokuapp.com|https://dry-retreat-2699.herokuapp.com/images/Reflektive-Icon-1024.png>"
...
def post_message
  response = Slack.chat_postMessage(:channel => "#general", :username => "Reflektive Bot", :text => "Hey from the Reflektive team!")
  puts "RESPONSE: #{response["ts"]}"
end
